...
public class MyPage_UploadList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_page_upload_list);
        ...
        arw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MyPage_UploadList.this, MyPage_0.class);
                startActivity(i);
                finish();
            }
        });
        ...
        pager.setAdapter(new MyPage_UploadList.PageAdapter(getSupportFragmentManager(),this)); //뷰페이저 어뎁터 설정 연결


    }
    public static class PageAdapter extends FragmentStatePagerAdapter { //뷰 페이저 어뎁터
